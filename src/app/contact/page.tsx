...
export const metadata: Metadata = {
  title: "ຕິດຕໍ່ພວກເຮົາ | ຄຳສັບພາສາລາວ",
  description:
    "ຕິດຕໍ່ທີມ ຄຳສັບພາສາລາວ (laoswords.com). ສົ່ງຄຳແນະນຳ, ແຈ້ງຄຳຜິດ, ຫຼື ຮ່ວມພັດທະນາວັດຈະນານຸກົມລາວ-ອັງກິດ.",
  alternates: {
    canonical: "/contact",
  },
  openGraph: {
    title: "ຕິດຕໍ່ພວກເຮົາ | ຄຳສັບພາສາລາວ",
    description:
      "ຕິດຕໍ່ທີມ ຄຳສັບພາສາລາວ ເພື່ອສົ່ງຄຳແນະນຳ ຫຼື ຮ່ວມພັດທະນາ.",
...
const contactCards = [
  {
    ...
    title: "whatsapp",
    description: "ສົ່ງຄຳແນະນຳ ຫຼື ຄຳຖາມ",
  ...
  },
  {
    ...
    title: "ເວັບໄຊ",
    description: "ເຂົ້າເບິ່ງເວັບໄຊຂອງພວກເຮົາ",
        ...
        <div className="max-w-4xl mx-auto space-y-16">
          ...
          <div className="text-center space-y-6">
            <h1 className="text-5xl md:text-6xl font-light tracking-tight text-gray-900">
              ຕິດຕໍ່{" "}
              <span className="font-medium text-[#205781]">ພວກເຮົາ</span>
            </h1>
            <p className="text-xl text-gray-600 max-w-2xl mx-auto leading-relaxed">
              ພວກເຮົາຍິນດີຮັບຟັງທຸກຄຳແນະນຳ ແລະ ຄຳຄິດເຫັນ
              ເພື່ອປັບປຸງວັດຈະນານຸກົມລາວ-ອັງກິດ ໃຫ້ດີຂຶ້ນ.
            </p>
          </div>
          ...
          <section className="bg-white rounded-3xl border border-gray-100 shadow-sm p-8 sm:p-10">
            <h2 className="text-2xl font-semibold text-gray-900 mb-6">
              ສິ່ງທີ່ທ່ານສາມາດແຈ້ງໃຫ້ພວກເຮົາຊາບ
            </h2>
            <div className="grid sm:grid-cols-2 gap-6">
              <div className="flex gap-4">
                ...
                <div>
                  <h3 className="font-medium text-gray-900">ແຈ້ງຄຳຜິດ</h3>
                  <p className="text-sm text-gray-500">
                    ຫາກພົບຄຳທີ່ສະກົດຜິດ ຫຼື ແປຜິດ
                  </p>
                </div>
              </div>
              <div className="flex gap-4">
                ...
                <div>
                  <h3 className="font-medium text-gray-900">ເພີ່ມຄຳສັບ</h3>
                  <p className="text-sm text-gray-500">
                    ແນະນຳຄຳສັບໃໝ່ທີ່ຄວນມີໃນວັດຈະນານຸກົມ
                  </p>
                </div>
              </div>
              <div className="flex gap-4">
                ...
                <div>
                  <h3 className="font-medium text-gray-900">ຄຳແນະນຳ</h3>
                  <p className="text-sm text-gray-500">
                    ແນະນຳຟີເຈີໃໝ່ ຫຼື ປັບປຸງເວັບໄຊ
                  </p>
                </div>
              </div>
              <div className="flex gap-4">
                ...
                <div>
                  <h3 className="font-medium text-gray-900">ຮ່ວມພັດທະນາ</h3>
                  <p className="text-sm text-gray-500">
                    ສົນໃຈຮ່ວມພັດທະນາ ຫຼື ສະໜັບສະໜູນ
                  </p>
                </div>
              </div>
            </div>
