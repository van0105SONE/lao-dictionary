...
export default function LaoBasicsClient() {
  const [activeChapter, setActiveChapter] = useState("consonants");
  const [selectedConsonant, setSelectedConsonant] = useState<
    null | (typeof CONSONANTS)[0]
  >(null);
    ...
    <div style={{ fontFamily: "'Noto Serif Lao', serif" }}>
      ...
      >
        ...
        >
          ...
          <p
            style={{ fontSize: "14px", opacity: 0.6, marginBottom: "36px" }}
            lang="en"
          >
          ...
          >
            {[
              ...
              >
                ...
                <div style={{ fontSize: "11px", opacity: 0.6 }} lang="en">
                  {s.labelEn}
                </div>
              </div>
            ))}
      ...
      >
        ...
        >
          ...
          <span
            style={{ opacity: 0.75, fontWeight: 400, fontSize: "13px" }}
            lang="en"
          >
      ...
      {/* ── Two-column layout: content + ad sidebar ──────────────────── */}
      <div className="lao-basics-grid">
        {/* ── Main content panels ──────────────────────────────────────── */}
        <div>
          {/* CONSONANTS ────────────────────────────────────────────────── */}
          {activeChapter === "consonants" && (
            <div>
              ...
              >
                ພາສາລາວມີພະຍັນຊະນະທັງໝົດ{" "}
                <strong style={{ color: "#205781" }}>33 ຕົວ</strong> ແບ່ງອອກເປັນ
                3 ໝວດ: ໝວດກາງ, ໝວດສູງ ແລະ ໝວດຕ່ຳ.
                ໝວດຂອງພະຍັນຊະນະກຳນົດວັນນະຍຸດຂອງຄຳ.
                <span
                  lang="en"
                  style={{
                    display: "block",
                ...
                >
                  Lao has 33 consonants classified into 3 classes: middle, high,
                  and low — which determine the tone of syllables.
                </span>
              </p>
                  ...
                  <button
                    ...
                    onClick={() =>
                      setSelectedConsonant(
                        selectedConsonant?.char === c.char ? null : c,
                      )
                    }
                    title={`${c.char} (${c.romanized}) — ${c.sound}`}
                    style={{
                      background:
                        selectedConsonant?.char === c.char
                ...
                >
                  ...
                  <div>
                    ...
                    >
                      ...
                      >
                        ໝວດ{" "}
                        {selectedConsonant.class === "middle"
                          ? "ກາງ"
                          : selectedConsonant.class === "high"
                            ? "ສູງ"
                            : selectedConsonant.class === "low"
                              ? "ຕ່ຳ"
                              : "ພິເສດ"}
                      </span>
                      <span
                    ...
                    >
                      {selectedConsonant.sound}
                    </div>
                    <div
                      style={{ fontSize: "14px", color: "#6B7280" }}
                      lang="en"
                    >
                      Class: <strong>{selectedConsonant.class}</strong> ·
                      Romanization:{" "}
                      <strong>{selectedConsonant.romanized}</strong>
                    </div>
                  </div>
                </div>
              )}
                ...
                {[
                  {
                    cls: "middle",
                    lo: "ໝວດກາງ",
                    en: "Middle class — 9 consonants. Produce mid or low tones.",
                  },
                  {
                    cls: "high",
                    lo: "ໝວດສູງ",
                    en: "High class — 11 consonants. Produce high or rising tones.",
                  },
                  {
                    cls: "low",
                    lo: "ໝວດຕ່ຳ",
                    en: "Low class — 11 consonants. Produce low or falling tones.",
                  },
                ].map((item) => (
                  <div
                    key={item.cls}
          ...
          {activeChapter === "vowels" && (
            <div>
              ...
              >
                ພາສາລາວມີສະຫຼະທັງໝົດ{" "}
                <strong style={{ color: "#205781" }}>24 ຮູບ</strong> ແບ່ງເປັນ
                ...
                >
                  Lao has 24 vowels: 9 short vowels, 9 long vowels, and 6
              ...
              >
                ...
                >
                  ສະຫຼະປະສົມ{" "}
                  <span lang="en" style={{ fontWeight: 400, fontSize: "14px" }}>
          ...
          {activeChapter === "tones" && (
            <div>
              ...
              >
                ພາສາລາວເປັນພາສາຮູບເງົາ ມີ{" "}
                <strong style={{ color: "#205781" }}>6 ສຽງວັນນະຍຸດ</strong>.
                ...
                >
                  Lao is a tonal language with 6 distinct tones. The tone of a
                  syllable depends on: the consonant class + tone mark +
                  syllable type.
                </span>
              </p>
          ...
          {activeChapter === "words" && (
            <div>
              ...
              >
                ...
                >
                  Lao words are meaningful language units. They can be
                  classified by their formation into 4 main types.
                </span>
              </p>
            ...
            <div>
              ...
              >
                ...
                <p
                  ...
                  lang="en"
                >
                  Basic Principles of Lao Language Usage — Volume 1 is an
                  official educational reference published by the Ministry of
                  Education and Sports of the Lao People&apos;s Democratic
                  Republic in 2024.
                </p>
                <div
                  style={{
              ...
              <div style={{ textAlign: "center", marginTop: "40px" }}>
                ...
                >
                  📥 ດາວໂຫຼດ PDF ຕົ້ນສະບັບ
                  <span
                    style={{ fontWeight: 400, fontSize: "13px", opacity: 0.85 }}
                    lang="en"
                  >
                    Download original PDF
                  </span>
        ...
        {/* ── End main content panels ──────────────────────────────────── */}

        {/* ── Ad Sidebar ───────────────────────────────────────────────── */}
        <aside
          className="lao-basics-sidebar"
          style={{
            position: "sticky",
            top: "80px",
            display: "flex",
        ...
        >
          ...
          <div
            style={{
              ...
              padding: "20px",
              color: "white",
              boxShadow: "0 4px 16px rgba(32,87,129,0.2)",
            }}
          >
            <h3
              style={{
            ...
            >
              {[
                { href: "/", label: "ຄົ້ນຫາຄຳສັບ", labelEn: "Search Words" },
                {
                  href: "/correct-incorrect",
                  label: "ຄຳຖືກ ແລະ ຜິດ",
                  labelEn: "Correct & Incorrect",
                },
                { href: "/aboutus", label: "ກ່ຽວກັບເຮົາ", labelEn: "About Us" },
              ].map((link) => (
                <li key={link.href}>
                  <a
                    href={link.href}
...
function VowelRow({
  ...
  vowel: { form: string; ipa: string; name: string; romanized: string };
  color: string;
}) {
  return (
    <div
