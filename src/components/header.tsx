    ...
    <div>
      ...
      <nav className="fixed min-w-screen bg-[#205781] p-4 z-50">
        <div className="container mx-auto flex justify-between items-center">
          ...
          >
            <span
              className={`flex items-center gap-1 transition-all duration-200 ${lang === "lo" ? "opacity-100 scale-105" : "opacity-35 scale-95"}`}
            >
              <Image
                src="/laos.png"
                alt="ລາວ"
            ...
            <span
              className={`flex items-center gap-1 transition-all duration-200 ${lang === "en" ? "opacity-100 scale-105" : "opacity-35 scale-95"}`}
            >
              <Image
                src="/flag-uk.svg"
                alt="English"
